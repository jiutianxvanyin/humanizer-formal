...
- **目标 L2（默认：研究报告、投资备忘录、尽调报告、学位论文）**：参照 10-K，
  句长 28–30 词，p90/p50 约 1.78，名词化 49–51
- 目标 L1（期刊投稿、政府公文）：句长可到 37，p90/p50 约 2.3，名词化 50，
  抽象名词与 AI 词表可高于 L2
- 目标 L3（教科书、科普、面向非专业读者）：句长 24–30 词，p90/p50 约 1.9，
  名词化 35–39
- 从 L1 降到 L3：句长砍约三成，长句（>50 词）占比从 19% 降到 6%，
  抽象名词砍到十分之一

**名词化在 L1 与 L2 上都是 50 上下**，两级的区别在句长与长句占比，不在
名词化。这是 10-K 与研究生专著实测值几乎相同（49.6、50.6 对 50.0）的直接
后果，不是取值失误。
...
论文）AI 词表密度超过 1，几乎确定语域不合，不论作者是谁。
...
这两项虽未用 AI 语料验证，但**人写实测极低**，所以出现即可改：
...
所以英文侧**不要削减限定语**，只检查一件事：限定强度是否与证据强度相称。
无差别地对每句话都加限定是问题，该限定的地方限定不是问题。
